---
task_id: d7f9cc88-9dce-4a64-be55-d9583024149d
title: اصلاح نوع داده due_date در Pydantic و SQLAlchemy
type: bug
priority: high
...
created_at: '2026-05-19T20:23:24.845911+00:00'
...
# اصلاح نوع داده due_date در Pydantic و SQLAlchemy
...
1. فیلد due_date در schema از نوع date است _(verify: static)_
2. ایجاد task با due_date بدون خطا کار می‌کند _(verify: api_response)_
3. تست‌های مربوط به tasks پاس می‌شوند _(verify: backend_test)_
