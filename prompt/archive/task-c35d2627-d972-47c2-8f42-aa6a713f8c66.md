---
task_id: c35d2627-d972-47c2-8f42-aa6a713f8c66
title: تعیین تکلیف endpoint بلااستفاده PATCH /{notification_id}/read
type: audit
priority: medium
...
created_at: '2026-05-26T20:27:19.775752+00:00'
updated_at: '2026-05-29T20:35:02.160553+00:00'
archived: true
...
# تعیین تکلیف endpoint بلااستفاده PATCH /{notification_id}/read
...
---
[scan #2 at 2026-05-26T20:27:20.383367+00:00]
## 📋 شرح
endpoint `DELETE /{notification_id}` در `app/routes/notifications.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
1. مشخص شد endpoint `PATCH /{notification_id}/read` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
