---
task_id: 67beb41c-9454-453f-91aa-876488f647ad
title: Fix hardcoded admin email RBAC bypass
type: security
priority: critical
...
created_at: '2026-06-02T20:53:25.825445+00:00'
updated_at: '2026-06-05T17:24:02.050589+00:00'
archived: true
archived_at: '2026-06-05T17:23:55.837425+00:00'
---

# Fix hardcoded admin email RBAC bypass

## Raw Idea

In `app/routes/auth_google.py`, admin authorization is performed by comparing the current user's email against a hardcoded string `"mohamad.mahdi1988@gmail.com"` at lines
...
Hardcoded admin email bypasses role-based access control
