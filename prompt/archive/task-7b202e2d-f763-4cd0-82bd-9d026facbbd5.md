---
task_id: 7b202e2d-f763-4cd0-82bd-9d026facbbd5
title: 'رسیدگی به endpoint بلااستفاده: PATCH /{integration_id}'
type: audit
priority: medium
...
created_at: '2026-05-26T20:27:16.112752+00:00'
updated_at: '2026-05-29T20:34:56.671613+00:00'
archived: true
...
# رسیدگی به endpoint بلااستفاده: PATCH /{integration_id}
...
---
[scan #2 at 2026-05-26T20:27:16.702350+00:00]
## 📋 شرح
endpoint `DELETE /{integration_id}` در `app/routes/integrations.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
1. مشخص شد endpoint `PATCH /{integration_id}` در کدام دسته است (orphan/internal/deprecated) _(verify: manual_only)_
