...
updated_at: '2026-06-05T05:30:32.810288+00:00'
archived: true
archived_at: '2026-06-05T05:30:26.689692+00:00'
target_files:
...
- [x] **مرحله 1: ایجاد تست‌های integration برای ai_service** — این مرحله شامل نوشتن تست‌های integration برای سرویس ai_service است. تست‌ها باید تعامل ai_service با دیتابیس و سایر سرویس‌ها را پوشش دهند. این مرحله شامل نوشتن تست‌های unit برای routeها نمی‌شود. نکته حیاتی: تست‌ها باید در مسیر tests/integration/ ایجاد شوند و از دیتابیس تستی استفاده کنند.
- [x] **مرحله 2: ایجاد تست‌های integration برای auth_service** — این مرحله شامل نوشتن تست‌های integration برای سرویس auth_service است. تست‌ها باید تعامل auth_service با دیتابیس و سایر سرویس‌ها را پوشش دهند. این مرحله شامل نوشتن تست‌های unit برای routeها نمی‌شود. نکته حیاتی: تست‌ها باید در مسیر tests/integration/ ایجاد شوند و از دیتابیس تستی استفاده کنند.
