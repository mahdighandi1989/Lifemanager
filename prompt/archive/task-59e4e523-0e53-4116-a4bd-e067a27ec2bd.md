---
task_id: 59e4e523-0e53-4116-a4bd-e067a27ec2bd
title: حذف کد Inspector Bridge از production
type: security
priority: critical
...
created_at: '2026-06-02T20:53:25.998206+00:00'
updated_at: '2026-06-05T18:32:16.521073+00:00'
archived: true
archived_at: '2026-06-05T18:32:10.539333+00:00'
---

# حذف کد Inspector Bridge از production

## Raw Idea

فایل frontend/index.html شامل یک اسکریپت کامل Inspector Bridge (خطوط 10-400+) است که به یک WebSocket خارجی (wss://ai-creator-backend-q677.onrender.com) متصل می‌شود. این اسکریپت تمام تعاملات کاربر (کلیک‌ها، اسکرول‌ها
---
[scan #2 at 2026-06-02T21:06:55.963688+00:00]
فایل frontend/index.html شامل یک اسکریپت کامل Inspector Bridge است که در خط ۲۹ یک WebSocket URL سخت‌کد شده دارد: `wss://ai-creator-backend-q677.onrender.com/api/render/ws/bridge/gh_mahdighandi1989_lifemanager`. این URL به یک سرور خارجی (ai-creator-backend-q677.onrender.com) اشاره می‌کند و اسکریپت تم
...
کد Inspector Bridge در frontend/index.html: کد شخص ثالث غیرمجاز در production
