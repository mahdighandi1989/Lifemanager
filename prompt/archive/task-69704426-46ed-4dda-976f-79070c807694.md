---
task_id: 69704426-46ed-4dda-976f-79070c807694
title: 'رسیدگی به endpoint بلااستفاده: POST /generate'
type: audit
priority: medium
...
created_at: '2026-05-26T20:27:14.250863+00:00'
updated_at: '2026-05-29T20:34:53.996154+00:00'
archived: true
...
# رسیدگی به endpoint بلااستفاده: POST /generate
...
---
[scan #2 at 2026-05-26T20:27:14.845542+00:00]
## 📋 شرح
endpoint `GET /configs` در `app/routes/ai.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
endpoint بدون 
---
[scan #3 at 2026-05-26T20:27:15.195136+00:00]
## 📋 شرح
endpoint `POST /configs` در `app/routes/ai.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.
...
endpoint بدو
---
[scan #4 at 2026-05-26T20:27:15.529961+00:00]
## 📋 شرح
...
## 
---
[scan #5 at 2026-05-26T20:27:15.826543+00:00]
## 📋 شرح
...
#
---
[scan #6 at 2026-05-26T20:27:16.112478+00:00]
## 📋 شرح
