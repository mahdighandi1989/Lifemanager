...
updated_at: '2026-06-09T21:30:59.244365+00:00'
target_files:
- requirements.txt
---
...
1. فایل `requirements.txt` در ریشه پروژه ایجاد شود.
2. فایل شامل حداقل وابستگی‌های اصلی (fastapi, uvicorn, sqlalchemy, pydantic) باشد.
3. اجرای `pip install -r requirements.txt` با موفقیت وابستگی‌ها را نصب کند.
