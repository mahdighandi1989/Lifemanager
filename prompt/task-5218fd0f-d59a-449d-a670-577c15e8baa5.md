...
updated_at: '2026-06-02T21:10:28.363100+00:00'
target_files:
...
1. تابع recordLocation در api.js وجود داشته باشد
2. LocationTracker.jsx بعد از دریافت موقعیت، recordLocation را فراخوانی کند
3. داده در دیتابیس از طریق endpoint ذخیره شود
