...
updated_at: '2026-06-09T21:32:00.442055+00:00'
target_files:
- config/.env.example
---
...
1. `config/.env.example` فقط حاوی مقادیر جایگزین یا خالی برای متغیرهای حساس است.
2. هر متغیر در `.env.example` به وضوح مستند شده است.
3. برنامه دارای بررسی‌های زمان اجرا برای جلوگیری از راه‌اندازی با متغیرهای محیطی حیاتی از دست رفته یا پیش‌فرض‌های ناامن است.
