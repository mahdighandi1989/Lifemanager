...
updated_at: '2026-06-09T21:32:01.771434+00:00'
target_files:
...
1. تمام عملیات‌های پایگاه داده در `try/except` بلاک‌های مناسب قرار دارند.
2. خطاهای پایگاه داده با جزئیات کافی (شامل traceback) لاگ می‌شوند.
3. تراکنش‌های پایگاه داده در صورت بروز خطا به درستی rollback می‌شوند.
4. تست‌های واحد برای سناریوهای شکست پایگاه داده اضافه می‌شوند.
