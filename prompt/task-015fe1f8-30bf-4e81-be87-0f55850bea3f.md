...
updated_at: '2026-06-09T21:30:58.923527+00:00'
target_files:
...
1. یک ورک‌فلو GitHub Actions یک اسکنر آسیب‌پذیری وابستگی‌ها را اجرا می‌کند.
2. اسکنر با موفقیت هرگونه آسیب‌پذیری شناخته شده در وابستگی‌های پروژه را شناسایی می‌کند.
3. خط لوله CI/CD در صورت معرفی آسیب‌پذیری‌های با شدت بالا، شکست می‌خورد.
