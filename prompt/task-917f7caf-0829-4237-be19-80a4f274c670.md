...
updated_at: '2026-06-09T21:32:01.420575+00:00'
target_files:
- app/api/routes/
---
...
1. All API endpoints that accept user input utilize Pydantic models for request body and query parameter validation.
2. Pydantic models define appropriate length, type, and format constraints for all fields.
3. No direct string concatenation is used to build SQL queries; parameterized queries or ORM methods are exclusively used for database interactions.
