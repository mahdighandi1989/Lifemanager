...
updated_at: '2026-06-02T21:53:19.807379+00:00'
---
...
- [ ] `Until` در هیچ direct import مصرف نمی‌شود + هیچ transitive dep ای آن را require نمی‌کند
...
1. گام ۱: `npm/pip list --depth=0` و grep import روی `Until`.
...
1. `Until` در هیچ direct import مصرف نمی‌شود + هیچ transitive dep ای آن را require نمی‌کند _(verify: static)_
