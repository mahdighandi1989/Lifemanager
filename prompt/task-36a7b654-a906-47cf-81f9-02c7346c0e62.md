...
updated_at: '2026-06-09T21:32:00.794575+00:00'
target_files:
- .env.example
---
...
1. Every environment variable referenced in the application code has an entry in `.env.example`.
2. Each entry in `.env.example` includes a brief description of its purpose.
3. The project can be successfully run by configuring variables based solely on the updated `.env.example`.
