...
updated_at: '2026-06-09T21:32:00.906713+00:00'
target_files:
- alembic.ini
- alembic/env.py
---
...
1. فایل `alembic.ini` در ریشه پروژه ایجاد شود.
2. دایرکتوری `alembic/` با فایل‌های `env.py` و `script.py.mako` ایجاد شود.
3. دایرکتوری `alembic/versions/` ایجاد شود.
4. فایل `alembic/env.py` برای import کردن مدل‌های SQLAlchemy برنامه پیکربندی شود.
