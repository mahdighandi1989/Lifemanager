...
updated_at: '2026-06-09T21:30:59.030206+00:00'
target_files:
...
1. یک کار CI/CD، `alembic check` (یا معادل آن) را اجرا می‌کند و در صورت عدم همگام‌سازی مدل‌ها و مهاجرت‌ها، با شکست مواجه می‌شود.
2. مستنداتی برای توسعه‌دهندگان در مورد نحوه تولید و اعمال صحیح مهاجرت‌ها وجود دارد.
3. هیچ تغییر دستی در طرح‌واره پایگاه داده بدون مهاجرت‌های Alembic مربوطه انجام نمی‌شود.
