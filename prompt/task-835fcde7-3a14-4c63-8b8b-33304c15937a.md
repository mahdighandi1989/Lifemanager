---
task_id: 835fcde7-3a14-4c63-8b8b-33304c15937a
...
created_at: '2026-06-02T21:10:59.347519+00:00'
updated_at: '2026-06-03T18:43:51.868350+00:00'
---
...
## 🔍 جزئیات
- علت: field else has different defaults: ['SelfImprovementDailyUpdate.model_validate(payload)', 'os.environ.get("ENCRYPTION_KEY")', '"distant"']
---
[scan #2 at 2026-06-02T21:10:59.537461+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field api_key has different defaults: ['None,', 'Depends(get_openai_api_key),', '
---
[scan #3 at 2026-06-02T21:10:59.635908+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field payload has different defaults: ['Depends(get_optional_user_id),', 'Depends
---
[scan #4 at 2026-06-02T21:10:59.733908+00:00]
## 📋 شرح
فیلد `provider` در `` در دو یا چند جای مختلف default value متفاوت دارد.

## 🤔 چرا مهم است
defaults متناقض باعث می‌شود رفتار سیستم به ترتیب اجرا/import وابسته شود — bug های غیرقابل reproduce.

## 🔍 جزئیات
- علت: field provider has different defaults: ['Field(..., min_length=1, max_length=64)
---
[scan #5 at 2026-06-02T21:10:59.833735+00:00]
## 📋 شرح
...
## 🔍 جزئیات
- علت: field user_id has different defaults: ['"holistic_profile"', 'None  # populated f
---
[scan #6 at 2026-06-02T21:10:59.932064+00:00]
## 📋 شرح
