...
updated_at: '2026-06-09T21:30:59.135326+00:00'
target_files:
- .
---
...
1. A `requirements.txt` file exists in the repository root.
2. The `requirements.txt` file lists all direct project dependencies with pinned versions (e.g., `package==X.Y.Z`).
3. Running `pip install -r requirements.txt` in a fresh virtual environment successfully installs all necessary packages without errors.
