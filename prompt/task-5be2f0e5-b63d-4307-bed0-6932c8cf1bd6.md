...
updated_at: '2026-06-09T21:32:01.155741+00:00'
target_files:
- tests/__init__.py
- tests/test_main.py
---
...
1. دایرکتوری `tests/` در ریشه پروژه ایجاد شود.
2. فایل `tests/__init__.py` و `tests/test_main.py` ایجاد شوند.
3. فایل `tests/test_main.py` شامل یک تست ساده و موفقیت‌آمیز باشد.
4. اجرای `pytest` از ریشه پروژه، تست را با موفقیت پیدا و اجرا کند.
