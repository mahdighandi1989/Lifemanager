---
task_id: cbd6bc17-ee97-4ff4-8a18-1cf1054dbbef
title: 'endpoint بک‌اند بلااستفاده: GET /api/health'
type: audit
priority: medium
...
created_at: '2026-06-02T21:12:53.359408+00:00'
updated_at: '2026-06-03T18:44:28.732111+00:00'
target_files:
- app/main.py
---
...
---
[scan #2 at 2026-06-02T21:12:53.582958+00:00]
## 📋 شرح
...
## 🤔 چرا مهم اس
---
[scan #3 at 2026-06-02T21:12:53.693690+00:00]
## 📋 شرح
...
endpoint بدو
---
[scan #4 at 2026-06-02T21:12:53.803972+00:00]
## 📋 شرح
...
---
[scan #5 at 2026-06-02T21:12:53.917712+00:00]
## 📋 شرح
...
endpoi
---
[scan #6 at 2026-06-02T21:12:57.674773+00:00]
## 📋 شرح
endpoint `GET /api/assets` در `app/routes/assets.py` تعریف شده ولی هیچ `fetch`، `axios`، `apiClient.*`، یا frontend call به آن دیده نمی‌شود.

## 🔍 جزئیات
- method: `GET`
- path: `/api/assets`
- فایل: `app/routes/assets.py`
- علت: no frontend fetch + no recent call in logs
...
- `tests/test_self_improvement.py` — این فایل `main.py` را import می‌کند (caller)
