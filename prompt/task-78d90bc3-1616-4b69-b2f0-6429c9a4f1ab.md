...
updated_at: '2026-06-02T21:12:49.572469+00:00'
target_files:
...
1. git blame مشخص می‌کند چرا این دکمه `testProvider(p.id)} className="text-xs text-indigo-600 hover:underline">تست` فاقد handler است
