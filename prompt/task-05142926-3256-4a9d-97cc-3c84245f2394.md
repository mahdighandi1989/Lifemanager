...
updated_at: '2026-06-09T21:32:01.659866+00:00'
target_files:
...
1. تمام نقاط پایانی API ورودی‌های خود را در برابر محدودیت‌های منطق کسب‌وکار (مانند طول، فرمت، محدوده) اعتبارسنجی می‌کنند.
2. ورودی‌های نامعتبر با خطاهای HTTP مناسب (مانند 400 Bad Request) پاسخ داده می‌شوند.
3. تست‌های واحد برای پوشش edge case‌های اعتبارسنجی ورودی اضافه می‌شوند.
