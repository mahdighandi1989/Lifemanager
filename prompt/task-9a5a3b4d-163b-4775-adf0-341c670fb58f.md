...
updated_at: '2026-06-02T21:10:28.733019+00:00'
target_files:
...
1. get_optional_user_id حداقل امضای JWT را بررسی کند
2. endpointهای حساس (finance, assets, context) از get_current_user استفاده کنند
3. داده‌های کاربر 0 به کاربران واقعی منتقل شوند
4. تست‌های امنیتی برای دسترسی غیرمجاز اضافه شود
