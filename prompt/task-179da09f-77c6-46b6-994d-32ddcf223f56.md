---
task_id: 179da09f-77c6-46b6-994d-32ddcf223f56
title: کامپوننت‌های AIFeedbackWidget و RecommendationPanel به endpointهای واقعی متصل نیستند
type: bug
priority: high
...
created_at: '2026-06-02T21:10:28.456352+00:00'
updated_at: '2026-06-02T21:44:14.764098+00:00'
---

# کامپوننت‌های AIFeedbackWidget و RecommendationPanel به endpointهای واقعی متصل نیستند

## Raw Idea

AIFeedbackWidget.jsx و RecommendationPanel.jsx در frontend/src/components/ وجود دارند اما به endpointهای واقعی backend متصل نیستند. AIFeedbackWidget باید از POST /ai/feedback (app/routes/ai.py line 186) استفاده کند، و RecommendationPanel باید از GET /api/recommendations (app/routes/context.py line 189) استفاده کند. در frontend/src/lib/api.js هیچ تابعی برای این endpointها وجود ندارد.
...
1. اضافه کردن توابع submitFeedback و getRecommendations به frontend/src/lib/api.js. سپس AIFeedbackWidget.jsx و RecommendationPanel.jsx را
