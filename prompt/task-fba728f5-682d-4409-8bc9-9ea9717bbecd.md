...
updated_at: '2026-06-09T21:32:01.023150+00:00'
target_files:
...
1. فایل `.github/workflows/ci.yml` ایجاد شود.
2. ورک‌فلو شامل مراحل نصب وابستگی‌ها و اجرای `pytest` باشد.
3. ورک‌فلو در هر push به `main` و هر Pull Request اجرا شود.
