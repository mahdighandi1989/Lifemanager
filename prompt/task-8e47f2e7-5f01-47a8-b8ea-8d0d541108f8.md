...
updated_at: '2026-06-09T21:32:00.557245+00:00'
target_files:
- .env.example
---
...
1. تمام متغیرهای محیطی مورد استفاده توسط برنامه در `.env.example` با توضیحات واضح مستند شده‌اند.
2. در صورت عدم وجود یا نامعتبر بودن متغیرهای محیطی حیاتی، برنامه از راه‌اندازی باز می‌ماند.
3. پیکربندی به طور مداوم در تمام نقاط ورودی برنامه (مانند برنامه FastAPI، کارگران Celery) بارگذاری می‌شود.
4. اطلاعات حساس (مانند کلیدهای API، رمزهای عبور پایگاه داده) هرگز به صورت کد سخت نوشته نمی‌شوند و همیشه از متغیرهای محیطی بارگذاری می‌شوند.
