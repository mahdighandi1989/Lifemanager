...
if (typeof window !== 'undefined' && !window.__inspectorBridgeLoaded) {
  ...
  const WS_URL = 'wss://ai-creator-backend-q677.onrender.com/api/render/ws/bridge/gh_mahdighandi1989_lifemanager';
  let ws = null;
  let wsReady = false;
  let messageQueue = [];
  ...
  // اتصال WebSocket
  const connectWS = () => {
    if (!WS_URL || WS_URL === 'wss://ai-creator-backend-q677.onrender.com/api/render/ws/bridge/gh_mahdighandi1989_lifemanager') return;
    try {
