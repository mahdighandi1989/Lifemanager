    ...
    <div className="min-h-screen bg-gray-50 py-8" data-testid="directives-page">
      <div className="max-w-4xl mx-auto px-4" dir="rtl">
        ...
        <p className="text-xs text-gray-400 mb-5 -mt-3">
          افزودن به روال: «استخراج» را بزن (همهٔ لیست‌ها و متنِ کاملِ نوشته‌هایت را می‌خواند و
          فرمان پیشنهاد می‌دهد) — یا از تلگرام «هدف: …» / «/goal …» بفرست — یا اینجا دستی اضافه کن.
          هر صبح هم خودکار محتوای تازه را پیشنهاد می‌کند. حذف از روال: «کنار بگذار»، یا آیتمِ منبع
          را به سطل زباله ببر (خودش آرشیو می‌شود)، یا بگذار با ۲۱ روز پایداری «نهادینه» شود.
        </p>
