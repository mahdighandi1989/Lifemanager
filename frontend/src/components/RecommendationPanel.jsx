...
// RecommendationPanel (audit task 2165524b AC 5): renders the context-aware
// recommendations from GET /api/recommendations, each with accept/reject
// buttons. Accept/reject dismiss the card locally (best-effort UI feedback).
function RecommendationPanel() {
  ...
  return (
    <div data-testid="recommendation-panel" className="space-y-2">
