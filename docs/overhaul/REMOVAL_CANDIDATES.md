...
- **`self_model_diligence`** («پشتکارت این دوره …»)
  ...
  - *و جمله‌اش دروغ است:* «این دوره» هیچ پنجرهٔ زمانی ندارد.
    ...
    تاریخی روی فرمان‌ها، کارها و قلم‌های فهرست نیست — پس عبارتِ «این دوره» به چیزی
    اشاره نمی‌کند.
    - **تصحیح (۲۰۲۶-۰۸-۰۲، بعدِ بازبینیِ متخاصم):** نسخهٔ اولِ همین یادداشت نوشته بود
      «نمره هرگز نمی‌تواند بهتر شود». این **غلط بود** و اندازه‌گیری ردش کرد: با ۳ کارِ
      باز نمره ۰ است و با تمام‌کردنِ همان ۳ تا می‌شود ۱۰۰. ادعای درست این است که نمره
      **نسبتِ مادام‌العمر** است، پس با یک انباشتِ تاریخی هر تلاشِ تازه فقط کسری تکانش
      می‌دهد: با ۲۰۳ کار که ۲۰۰تایش قدیمی و باز است، تمام‌کردنِ ۲۰ کار نمره را از ۱ به
      ۱۱ می‌برد. اتهام قابلِ جبران است ولی به‌کندی — و همچنان بدونِ هیچ پنجرهٔ زمانی.
